...
include_once( DIR . 'utils' . DSZ . 'dump.class.php');
...
//	}
	...
	public function test_1() {
		$actual = dump::dump('one', null, array('Only Return Output String' => true, 'Beautify is On' => false));
	...
	public function test_3() {
		$x = 'two';
		$actual = dump::dump($x, 'title', array('Only Return Output String' => true, 'Beautify is On' => false));

		$expected = "'title<BR>" . '$x' . ", 'title', array('Only Return Output String' => true, 'Beautify is On' => false)<BR>two<BR>P:\Projects\NB_projects\php_code_base\\tests\utils\dump_Test.php (Line:78) <BR>'";
		$expected = ltrim($expected, "'");
		$expected = rtrim($expected, "'");
	...
	public function test_4() {
		...
		$expected = "'title<BR>" . '$x' . ", 'title', array('Only Return Output String' => true, 'Beautify is On' => false)<BR>Array\n"
				. "(\n"
				. "    [0] => one\n"
				. "    [1] => two\n"
				. ")\n"
				. "<BR>P:\Projects\NB_projects\php_code_base\\tests\utils\dump_Test.php (Line:89) <BR>'";
		$expected = ltrim($expected, "'");
		$expected = rtrim($expected, "'");
