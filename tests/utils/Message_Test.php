...
class AMessageTest extends TestCase {
	...
	public function test_Versions() {
		$this->assertEquals('0.3.0', AMessage::Version());
	}
...
//
	...
	function getPrettyLine_Dataprovider() {
		...
		return [
			'one' => [['Hello World', null, null],
				'[' . $nowIsh . '] <span class="msg_style_NOTICE">NOTICE </span>: Hello&nbsp;World'],
			'two' => [['Hello World', 'someFakeTextTimeStamp', anExtendedMessage::DEBUG],
				'[someFakeTextTimeStamp] <span class="msg_style_DEBUG">DEBUG </span>: Hello&nbsp;World'],
			'three' => [['Hello World', 'someFakeTextTimeStamp', anExtendedMessage::EMERGENCY],
				'[someFakeTextTimeStamp] <span class="msg_style_EMERGENCY">EMERGENCY </span>: Hello&nbsp;World'],
			'four' => [['Hello World', 'aNewFakeTS', null],
				'[aNewFakeTS] <span class="msg_style_NOTICE">NOTICE </span>: Hello&nbsp;World'],
			'five' => [[null, null, null],
				'[' . $nowIsh . '] <span class="msg_style_NOTICE">NOTICE </span>: '],
			'six' => [[null, 'someFakeTextTimeStamp', null],
				'[someFakeTextTimeStamp] <span class="msg_style_NOTICE">NOTICE </span>: '],
			'seven' => [[null, 'someFakeTextTimeStamp', anExtendedMessage::DEBUG],
				'[someFakeTextTimeStamp] <span class="msg_style_DEBUG">DEBUG </span>: '],
		];
	}
	...
	function test_show() {
		...
		$expected = '[' . $nowIsh . '] <span class="msg_style_NOTICE">NOTICE </span>: Hello&nbsp;World';
